...
export function CalendarClient({
  ...
  // The initial month's data already arrived via SSR (see page.tsx) —
  // skip the redundant client refetch on mount; month navigation still
  // triggers a normal client fetch.
