  ...
  return (
    <div className="flex gap-2.5 rounded-[var(--fg-radius-md)] bg-warning-bg p-3.5">
      ...
      <div className="flex flex-col gap-1">
        <span className="text-body-sm font-semibold text-text-primary">Before you book</span>
        <p className="text-body-sm text-text-secondary">
          Meet in public or at a registered studio for a first shoot, and let someone know where
          you&apos;ll be. Fgrapher never asks for payment outside the platform — report anything
          that feels off.
        </p>
      </div>
    </div>
