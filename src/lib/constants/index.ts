...
export const CATEGORIES_BY_ROLE: Partial<Record<Role, ProfileCategory[]>> = {
  PHOTOGRAPHER: [
    "WEDDING", "PORTRAIT", "FASHION", "COMMERCIAL", "EVENT", "PRODUCT",
    "FOOD", "LANDSCAPE", "STREET", "DOCUMENTARY", "CORPORATE", "REAL_ESTATE",
  ],
  VIDEOGRAPHER: [
    "WEDDING", "EVENT", "MUSIC_VIDEO", "CORPORATE", "DOCUMENTARY", "COMMERCIAL",
  ],
...
export const CATEGORY_LABELS: Record<ProfileCategory, string> = {
  WEDDING: "Wedding", PORTRAIT: "Portrait", FASHION: "Fashion", COMMERCIAL: "Commercial",
  EVENT: "Event", PRODUCT: "Product", FOOD: "Food", LANDSCAPE: "Landscape",
  STREET: "Street", DOCUMENTARY: "Documentary", MUSIC_VIDEO: "Music video",
  CORPORATE: "Corporate", REAL_ESTATE: "Real estate", BRIDAL: "Bridal",
  EDITORIAL: "Editorial", SFX: "SFX", NATURAL: "Natural", GLAM: "Glam",
  INDOOR: "Indoor", OUTDOOR: "Outdoor", ROOFTOP: "Rooftop", CYCLORAMA: "Cyclorama",
  GREEN_SCREEN: "Green screen", FASHION_MODEL: "Fashion", COMMERCIAL_MODEL: "Commercial",
  FITNESS_MODEL: "Fitness", PORTRAIT_MODEL: "Portrait", HAND_FOOT_MODEL: "Hand & foot",
  PLUS_SIZE: "Plus size", PETITE: "Petite", MATURE: "Mature", ALTERNATIVE: "Alternative",
};

export const EXPERIENCE_LEVEL_LABELS: Record<ExperienceLevel, string> = {
  NEW: "New", INTERMEDIATE: "Intermediate", EXPERIENCED: "Experienced", PROFESSIONAL: "Professional",
};
...
export const BOOKABLE_ROLES_BY_ROLE: Partial<Record<Role, Role[]>> = {
  CUSTOMER: ["PHOTOGRAPHER", "VIDEOGRAPHER", "MAKEUP_ARTIST", "STUDIO", "MODEL"],
